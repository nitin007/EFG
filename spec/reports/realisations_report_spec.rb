...
describe RealisationsReport do
  ...
  describe 'validations' do
    subject { RealisationsReport.new(cfe_user, report_options) }
  ...
  describe 'with valid options' do
    ...
    context 'when user is cfe_user' do
      subject(:report) { RealisationsReport.new(cfe_user, report_options) }

      its(:allowed_lenders) {
        should match_array(cfe_user.lenders << RealisationsReport::ALL_LENDERS_OPTION)
      }
    ...
    context 'when user is lender_user' do
      subject(:report) { RealisationsReport.new(lender_user, report_options) }
