...
Devise.setup do |config|
  ...
  config.mailer_sender = "EFG <efg-mailer@digital.cabinet-office.gov.uk>"
  ...
  # adapted from Lockable module
  # reset failed attempts to 0 after successful login of unlocked users
  Warden::Manager.after_set_user :except => :fetch do |record, warden, options|
    if record.respond_to?(:failed_attempts) && warden.authenticated?(options[:scope]) && !record.locked?
  ...
  # How many old passwords to keep in the archive
